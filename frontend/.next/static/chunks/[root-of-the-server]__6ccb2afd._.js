    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PatientProcess.useEffect": ()=>{
            ...
            fetch("".concat(API_URL, "/patients/").concat(patientId)).then({
                "PatientProcess.useEffect": (res)=>res.json()
            ...
            }["PatientProcess.useEffect"]).catch(console.error);
        }
    }["PatientProcess.useEffect"], [
        patientId
    ]);
...
_s(PatientProcess, "avNEQZPCkEnz8+fZUk8ab0W4G8E=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6ccb2afd._.js.map