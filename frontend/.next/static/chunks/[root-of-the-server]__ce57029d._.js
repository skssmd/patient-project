...
"[project]/src/pages/process/[id].tsx [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const PatientProcess = ()=>{
    ...
    const patientId = params === null || params === void 0 ? void 0 : params.id;
    ...
    const [weight, setWeight] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const [xAxisDomain, setXAxisDomain] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([
        0,
        100
    ]);
    // Dialog states
    ...
    const [processError, setProcessError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Fetch patient name
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PatientProcess.useEffect": ()=>{
            if (!patientId) return;
            fetch("".concat(API_URL, "/patients/").concat(patientId)).then({
                "PatientProcess.useEffect": (res)=>{
                    if (!res.ok) throw new Error("Server responded with ".concat(res.status));
                    return res.json();
                }
            }["PatientProcess.useEffect"]).then({
                "PatientProcess.useEffect": (data)=>{
                    var _data_series_result, _data_series;
                    const patient = (_data_series = data.series) === null || _data_series === void 0 ? void 0 : (_data_series_result = _data_series.result) === null || _data_series_result === void 0 ? void 0 : _data_series_result.patient;
                    if (!patient) throw new Error('Patient data missing');
                    setPatientName("".concat(patient.first_name, " ").concat(patient.last_name));
                }
            }["PatientProcess.useEffect"]).catch({
                "PatientProcess.useEffect": (err)=>{
                    console.error(err);
    ...
    const processPatient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$debounce$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])({
        "PatientProcess.useCallback[processPatient]": async (weightValue, heightValue)=>{
            if (!patientId) return;
            setLoading(true);
            setProcessError(null); // reset previous errors
            try {
                const res = await fetch("".concat(API_URL, "/patients/").concat(patientId, "/process"), {
                    method: 'POST',
                    headers: {
                ...
                if (!res.ok) {
                    ...
                    if (res.status === 429) {
                        ...
                        setProcessError(seconds ? "Server is busy. Please try again after ".concat(seconds, " seconds.") : 'Server is busy. Please try again after a few seconds.');
                        return;
                    }
                    throw new Error("Server responded with ".concat(res.status));
                }
                const data = await res.json();
                ...
                const concentrations = data.results.map({
                    "PatientProcess.useCallback[processPatient].concentrations": (d)=>d.concentration
                }["PatientProcess.useCallback[processPatient].concentrations"]);
                setXAxisDomain([
    ...
    }["PatientProcess.useCallback[processPatient]"], 500), [
        patientId
    ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                        ...
                        children: [
                            ...
                            graphData.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$component$2f$ResponsiveContainer$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ResponsiveContainer"], {
                                width: "100%",
                                height: 500,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["Dialog"], {
                open: !!processError,
                onOpenChange: ()=>setProcessError(null),
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            className: "text-center",
...
_s(PatientProcess, "P2fx7wyzXUm8L11yVk7KTStOZP4=", false, function() {
    return [
...
;
var _c;
__turbopack_context__.k.register(_c, "PatientProcess");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/process/[id].tsx [client] (ecmascript)\" } [client] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
const PAGE_PATH = "/process/[id]";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/src/pages/process/[id].tsx [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/src/pages/process/[id].tsx\" }": ((__turbopack_context__) => {
"use strict";

var { m: module } = __turbopack_context__;
{
__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/process/[id].tsx [client] (ecmascript)\" } [client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=%5Broot-of-the-server%5D__ce57029d._.js.map